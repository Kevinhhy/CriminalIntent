...
import database.CrimeDbSchema.CrimeCusorWrapper;
...
public class CrimeLab {
    ...
    public List<Crime> getCrimes(){
        ...
        CrimeCusorWrapper cursor = queryCrimes(null,null);
    ...
    public Crime getCrime(UUID id){
        CrimeCusorWrapper cursor = queryCrimes(CrimeDbSchema.CrimeTable.Cols.UUID + "= ?", new String[]{id.toString()});
    ...
    private CrimeCusorWrapper queryCrimes(String whereClause, String[] whereArgs) {
